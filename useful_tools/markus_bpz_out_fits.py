...
"""
Authors Micheal Rau  [tweaks, Ben Hoyle]
ensure bh_photo_z_validation is in python path.

This code takes the outputs of BPZ and generates point predictions

Call like
%>markus_pbz_out_fits.py Paths*ToBPZPredictions.bpz")

produces
*.bpz.fits

Note Z_SIGMA == Z_SIGMA_68
