...
availableZtables = ['hoyleb.PHOTOZ_HWE_Y1_V0_1', 'hoyleb.PHOTOZ_ADA_Z_Y1_V0_3', 'hoyeb.PHOT0Z_Y1_BPZ_V01', 'hoyleb.PHOTOZ_DNF_Y1_V01']
...
def show_help():
    ...
    print "./check_retrieve_data.py -h or help to see the help file"
    print "./check_retrieve_data.py redshift-table=" + '|'.join(availableZtables) + " sample-table=" + '|'.join(availableSamples) + " data-table=" + '|'.join(avaiableData) + " [,max-rows=5]"
