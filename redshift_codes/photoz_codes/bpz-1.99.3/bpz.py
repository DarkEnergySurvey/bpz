...
pars.d={
    ...
    'ODDS': 0.95,           # how much prob in main peak: Odds threshold: affects confidence limits definition
    ...
    'N_PEAKS':1, # how many peaks do we expect to find.
    'MERGE_PEAKS':'no',
    'CONVOLVE_P':'yes',
    'P_MIN':1e-2,
    'SED_DIR': sed_dir, # this assumes that these templates exist at all redshifts
    'AB_DIR': ab_dir, #this tells us how the z-changes.  
    'FILTER_DIR': fil_dir,
    'DELTA_M_0': 0.,
    'ZP_OFFSETS':0.,
    'ZC': None,
